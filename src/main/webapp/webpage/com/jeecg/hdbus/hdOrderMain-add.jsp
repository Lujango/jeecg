...
<head>
 ...
 <body>
  <form id="formobj" action="hdOrderMainController.do?doAdd" name="formobj" method="post"><input type="hidden" id="btn_sub" class="btn_sub"/>
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="orderGetTime" name="orderGetTime" type="text" style="width: 150px"  class="form-control" onClick="WdatePicker()"  type="date" pattern="yyyy-MM-dd"/>'>
			          ...
			          <div class="col-xs-3">
								<input id="leader" name="leader" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
