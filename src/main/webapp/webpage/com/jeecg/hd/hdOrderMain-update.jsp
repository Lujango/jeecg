...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="hdOrderMainController.do?doUpdate" >
		...
		<tr>
			...
			<td class="value">
					  <input id="orderGetTime" name="orderGetTime" type="text" style="width: 150px" 
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${hdOrderMainPage.orderGetTime}' type="date" pattern="yyyy-MM-dd"/>'>
			...
			<td class="value">
		     	 <input id="leader" name="leader" type="text" style="width: 150px" class="inputxt" value='${hdOrderMainPage.leader}'>
				<span class="Validform_checktip"></span>
