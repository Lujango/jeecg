 ...
 */
@Entity
@Table(name = "hd_order_sell", schema = "")
@SuppressWarnings("serial")
public class HdOrderSellEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="ADDR",nullable=true,length=32)
	 ...
	 */
	@Column(name ="RISK",nullable=true,length=32)
	 ...
	 */
	@Column(name ="P_ID",nullable=true,length=40)
