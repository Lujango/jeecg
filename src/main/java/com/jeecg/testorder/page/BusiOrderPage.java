...
package com.jeecg.testorder.page;
 ...
 *
 */
public class BusiOrderPage implements java.io.Serializable {
	/**主键*/
	...
	/**保存-业务单测试*/
    @ExcelCollection(name="业务单测试")
	private List<BusiOrderSalerEntity> busiOrderSalerList = new ArrayList<BusiOrderSalerEntity>();
		public List<BusiOrderSalerEntity> getBusiOrderSalerList() {
		return busiOrderSalerList;
		}
		public void setBusiOrderSalerList(List<BusiOrderSalerEntity> busiOrderSalerList) {
		this.busiOrderSalerList = busiOrderSalerList;
		}
}
